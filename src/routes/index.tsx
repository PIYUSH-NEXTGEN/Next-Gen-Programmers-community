    ...
    <ThemeProvider>
      <main id="top" className="min-h-screen bg-background text-foreground overflow-x-hidden">
        ...
        <section className="relative px-5 md:px-8">
          ...
          <div className="grain" />
          <div className="relative max-w-7xl mx-auto pt-16 md:pt-24 pb-20 md:pb-28 grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            {/* Left */}
            <div>
              ...
              >
                ...
                <JoinButton size="lg" variant="ghost" label="VISIT REDDIT" href={REDDIT_URL} />
              </div>
            </div>
            ...
            <div
              className="fade-up"
              style={{ animationDelay: `${HERO_TITLE_DURATION + 200}ms` }}
            >
        ...
        <section className="relative py-32 md:py-44 px-5 md:px-8 stripes overflow-hidden border-b border-border">
          ...
          <div className="relative max-w-5xl mx-auto text-center">
            ...
            <JoinButton size="lg" label="ENTER DISCORD" />
          </div>
        </section>

        {/* FOOTER */}
        <footer className="py-10 px-6 text-center font-mono text-[11px] tracking-[0.2em] text-muted-foreground">
          © NEXT-GEN PROGRAMMERS — Built by programmers, for programmers.
        </footer>
      </main>
    </ThemeProvider>
  );
